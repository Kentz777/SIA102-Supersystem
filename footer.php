        ...
        <div class="container">
            <div class="footer-wrapper d-flex">
                ...
                <div class="footer-col">
                    <h5>Social media </h5>
                    <ul>
                        <li><a href="https://www.facebook.com/alexandrethegrape">facebook</a></li>
                        <li><a href="https://www.facebook.com/alexandrethegrape">twitter</a></li>
                        <li><a href="https://www.facebook.com/alexandrethegrape">instagram</a></li>
                        <li><a href="#">Youtube</a></li>
                    </ul>
                </div>
            </div>
            <div class="copyright">
                <p>Copyright &copy; <a href="https://www.facebook.com/alexandrethegrape">Batch 1 Group 1.3</a> All rights reserved</p>
                <br><br>
            </div>
        </div>
    </footer>
