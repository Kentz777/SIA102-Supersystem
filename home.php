...
<section id="home">
  <h1 class="h-primary">Welcome to Foods and Room Services</h1>
...
<div class="form-group">
  ...
  <script>
    $(document).ready(function(){
      $('#category_fetch').on('change', function(){
        var v = $(this).val();
        alert(v);
        $.ajax({
          url: "fetch.php",
          ...
          data: "request=" + v,
          beforeSend: function(){
            $('.topseller').html("<span> Searching... </span>");
          },
          success:function(){
            $('.topseller').html(data);
        }
    ...
    $('#searchButton').click(function(e){
		...
		start_load()
		$.ajax({
			url:'ajax.php?action=select_category',
