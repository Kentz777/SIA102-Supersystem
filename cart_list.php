						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-4" style="text-align: -webkit-center">
									<a href="javascript:void(0)" class="delete_cart btn btn-sm btn-outline-danger"
				...
				<div class="sticky">
					<div class="card">
						<div class="card-body">
							...
							<hr>
							<p class="text-right" id = "total" data-id=<?php echo number_format($total, 2)?>><b>
	...
	function delete_cart_item(x) {
		...
		$.ajax({
			...
			success: function (resp) {
				if (resp == 1) {
					alert_toast("Item successfully deleted", 'success')
					load_carts();
					end_load();
