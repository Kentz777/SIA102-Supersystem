...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list" style="padding-top:5px;">
				...
				<?php if($_SESSION['login_type'] == 1): ?>
					<a href="#" class="nav-item nav-guests"><span class='icon-field'><i class="fa fa-users"></i></span> Guests</a>
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> Staffs</a>
				<a href="#" class="nav-item nav-services"><span class='icon-field'><i class="fa fa-users"></i></span> Services</a>
